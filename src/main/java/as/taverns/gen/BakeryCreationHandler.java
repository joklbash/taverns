...
public class BakeryCreationHandler implements IVillageCreationHandler
{
	...
	{
        return new StructureVillagePieces.PieceWeight(ComponentVillageBakery.class, Taverns.config.weightBakery,
